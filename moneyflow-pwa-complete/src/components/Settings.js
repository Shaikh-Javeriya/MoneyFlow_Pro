      ...
      <div className="page-content space-y-6">
              ...
              <div className="grid grid-cols-3 gap-2">
                {Object.entries(themes).map(([key, themeData]) => (
                  <button
                    ...
                    className={`btn flex items-center space-x-2 ${theme === key ? 'btn-primary' : 'btn-secondary'}`}
                  >
                    <div 
          ...
          <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-semibold text-green-600">{formatCurrency(stats.income)}</p>
              </div>
              <div>
                <p className="text-gray-600 dark:text-gray-400">Total Expenses</p>
                <p className="font-semibold text-red-600">{formatCurrency(stats.expenses)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="space-y-3 text-sm">
            <p>
              <strong>Local Storage Only:</strong> All your financial data is stored locally on your device. No data is sent to external servers.
            </p>
            <p>
              <strong>No Tracking:</strong> We don't track your usage, collect personal information, or share data with third parties.
            </p>
            <p>
              <strong>Secure Backups:</strong> Export your data anytime for secure backup. Import it on any device to restore your information.
            </p>
          </div>
        </div>
        ...
        {/* About */}
        <div className="card">
          <h2 className="font-semibold mb-4">About MoneyFlow Pro</h2>
